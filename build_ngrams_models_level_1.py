...
# 1-gram result
for x in dic:
        unigram_result = unigram_result + " " + str(dic[x] / count_unigram) + " " + str(
            log10(dic[x] / count_unigram)) + " " + x + "\n"
...
bigrams_open = "ngram 2: type=" + str(len(bigrams_dic)) + " token=" + str(bigrams_token_count) + "\n"
...
for x in bigrams_dic:
    bigrams_result = bigrams_result + " " + str(bigrams_dic[x] / bigrams_token_count) + " " + str(
        log10(bigrams_dic[x] / bigrams_token_count)) + " " + str(x[0] + " " + x[1]) + "\n"
...
trigrams_open = "ngram 3: type=" + str(len(trigrams_dic)) + " token=" + str(trigrams_token_count) + "\n"
...
for x in trigrams_dic:
    trigrams_result = trigrams_result + " " + str(trigrams_dic[x] / trigrams_token_count) + " " + str(
        log10(trigrams_dic[x] / trigrams_token_count)) + " " + str(x[0] + " " + x[1] + " " + x[2]) + "\n"
print("step 3")

# output
print("result")
result = result + unigram_open + bigrams_open + trigrams_open + unigram_result + bigrams_result + trigrams_result
